...
rootdir: /tmp/hermes_worktree_00c6986
...
```json
{
  ...
  "run_repo_sha": "00c6986c6c17ce222ece639bac3e624a600bc8df",
  ...
  "hermetic": true,
  "worktree_path": "/tmp/hermes_worktree_00c6986",
  "scratch_path": "/var/folders/q3/bnxyvqv53kn_0kxh5dgjy7g40000gn/T/tmp.VwHa2FoQPI"
}
```
...
**P95 = 0.035ms < 50ms requirement ✅**

### Hermetic Confirmation

**Scratch directory before:**
```
$ find /var/folders/q3/bnxyvqv53kn_0kxh5dgjy7g40000gn/T/tmp.VwHa2FoQPI -maxdepth 3
/var/folders/q3/bnxyvqv53kn_0kxh5dgjy7g40000gn/T/tmp.VwHa2FoQPI
```

**Network block proof:**
```
$ HERMES_HERMETIC=1 python3 -c "import socket; s=socket.socket(); s.settimeout(1); s.connect(('8.8.8.8', 53))"
