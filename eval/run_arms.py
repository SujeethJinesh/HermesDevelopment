...
from eval._seed import seed_all, compute_task_seed, generate_deterministic_id
...
def main():
    ...
    parser.add_argument(
        "--arm",
        choices=["A", "C", "PM", "D1", "D1_SAE"],
        required=True,
        help="Arm to evaluate"
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="N",
        help="Run N toy tasks for testing"
    )
