...
class TestHermeticIntegration:
    ...
    def test_hermetic_selftest_determinism(self):
        ...
        cmd_base = [
            sys.executable, "-m", "env.hermetic", "selftest",
            "--task-id", "MVP-0-F0.1-T0.1",
            "--seed", "123"
        ]
    ...
    def test_hermetic_metrics_generation(self):
        ...
        standard_keys = [
            "bytes_per_solve", "tokens_prefill", "tokens_decode",
            "e2e_latency_ms_p50", "e2e_latency_ms_p95",
            "message_path_ms_p95", "mcp_deref_ms_p95",
            "sae_accept_rate", "rollback_ms_p95", "pass_at_1"
        ]
