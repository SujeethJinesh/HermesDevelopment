...
class TestAgentsE2E:
    ...
    def test_arm_a_ten_tasks(self):
        ...
        # Create runner
        runner = ArmRunner(
            arm="A", seed=123, gen_cfg_path="configs/generation.yaml", hermetic=True, toy_tasks=10
        )
    ...
    def test_arm_c_ten_tasks(self):
        ...
        # Create runner
        runner = ArmRunner(
            arm="C", seed=456, gen_cfg_path="configs/generation.yaml", hermetic=True, toy_tasks=10
        )
    ...
    def test_hermetic_cleanup(self):
        ...
        # Run tasks
        runner = ArmRunner(
            arm="A", seed=777, gen_cfg_path="configs/generation.yaml", hermetic=True, toy_tasks=2
        )
        runner.run()
