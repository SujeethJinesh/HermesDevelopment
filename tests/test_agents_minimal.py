...
class TestProtobufRoundTrip:
    ...
    def test_plan_request_response(self):
        ...
        resp = baseline_pb2.PlanResponse(
            steps=["Step 1", "Step 2"], approach="direct fix", confidence=85
        )
    ...
    def test_code_request_response(self):
        ...
        req = baseline_pb2.CodeRequest(
            task_id="proto-002", file_path="lib/util.py", plan_steps=["Analyze", "Patch"], seed=456
        )
    ...
    def test_test_request_response(self):
        ...
        req = baseline_pb2.TestRequest(
            task_id="proto-003", test_name="test_feature", patch="patch data", seed=789
        )
        ...
        resp = baseline_pb2.TestResponse(
            passed=True, output="All tests passed", duration_ms=234, failures=[]
        )
